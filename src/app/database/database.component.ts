...
export class DatabaseComponent {
  ...
  fetchData(): Observable<any> {
    return this.http.get<any>('https://localhost:7205/api/database_test');
  }

  sendData(data: any) {
    return this.http.post('https://localhost:7205/api/database/add', data);
  }

  deleteData(id: number) {
    return this.http.delete(`https://localhost:7205/api/database/delete/${id}`);
  }
